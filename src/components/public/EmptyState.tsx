    ...
    <div className="flex flex-col items-center justify-center rounded-3xl glass-card px-6 py-16 text-center max-w-lg mx-auto">
      ...
      {onReset && (
        <button
          type="button"
          onClick={onReset}
          className="mt-5 inline-flex items-center gap-2 px-6 py-2.5 rounded-full glass-btn-primary text-xs font-bold text-white shadow-md cursor-pointer transition-all hover:scale-105 active:scale-95"
        >
